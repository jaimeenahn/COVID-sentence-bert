...
from .data_utils.create_training_files import get_text_tokens

from .data_utils.triplet_sampling import TripletGenerator
...
class SpecterDataReaderFromPickled(DatasetReader):
...
class SpecterDataReader(DatasetReader):
    ...
    def __init__(self,
        ...
        self.included_text_fields = set(included_text_fields.split()) if included_text_fields else None
